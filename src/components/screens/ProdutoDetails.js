...
const ProdutoDetails = (props) => {
    ...
    const orcamentoString = encodeURIComponent(`Olá! Gostaria de mais informações sobre o produto ${product.name}.`);
                ...
                <div className="col-12">
                    <div className="row">
                        ...
                        <div className="col-12 col-md-5 mb-3">
                            ...
                            <Orcamento href={`https://api.whatsapp.com/send?phone=5522992433029&text=${orcamentoString}`} target="_blank">Solicitar Orçamento</Orcamento>
                        </div>
